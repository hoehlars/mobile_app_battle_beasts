  ...
  describe('rendering', () => {
    it('renders the player image', () => {
      const testRenderer = renderer.create(
        <PlayerAvatar username="test" health={30} actionPoints={10} isOpponent={false} />,
      );
    ...
    it('renders the player image', () => {
      ...
      it('renders the player username', () => {
        ...
        const testInstance = testRenderer.root;
        expect(testInstance.findAllByProps({testID: 'username'}).length).not.toBeNull();
      });
      ...
      it('renders the player actionPoints', () => {
        ...
        const testInstance = testRenderer.root;
        expect(testInstance.findAllByProps({testID: 'actionPoints'})).not.toBeNull();
      });
  });
});
