...
class HomeScreenLogin extends React.Component<HomeScreenLoginProps,HomeScreenLoginState> {
    ...
    render(): JSX.Element {
        return (
            ...
            <LoginBox
            onSubmit={this.submitLoginData.bind(this)} /> : null}

            {this.state.loginError ?
            <ErrorBox
            text={this.state.loginError} />: null}
            
            {this.state.showRegisterButton ? <Button
                    title="Show Register"
            ...
            <RegisterBox 
            onSubmit={this.submitRegisterData.bind(this)}/> : null}
            {this.state.registerError ?

            <ErrorBox
            text={this.state.registerError} />: null}
