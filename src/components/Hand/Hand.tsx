...
import { ListRenderItemInfo, SafeAreaView, StyleProp, View, TouchableOpacity, Text  } from 'react-native';
...
[styles.SelectedCard]: this.props.canPlace && card.uniquePlayId === this.props.targetMode,*/
    ...
    if(!this.props.canPlace || data.item.isEquipment && !this.canPlaceEquipmentCard(data.item) || this.props.actionPoints < data.item.actionPoints) {
    ...
    return (
      ...
      {this.props.canPlace && this.state.selectedCard === data.item && !data.item.isSpell ? (
